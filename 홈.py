...
<div class="fr-header">
    ...
    <div class="fr-header-nav">
        <span class="fr-nav-btn" style="cursor: default;">Beta Test</span>
    </div>
</div>
''', unsafe_allow_html=True)
...
<div class="fr-footer">
    ...
    <p>당신의 꿈을 응원합니다</p>
    <p style="margin-top: 12px; font-size: 0.75rem; opacity: 0.7;">상호: 셀릭스 | 사업자등록번호: 680-52-00955 | 이메일: flyready.team@gmail.com</p>
